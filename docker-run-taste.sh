...
docker run -ti -P --privileged -v /dev/dri:/dev/dri:rw -v /tmp/.X11-unix:/tmp/.X11-unix -v /dev/ttyUSB0:/dev/ttyUSB0:rw \
    ...
    --name taste_container -e DISPLAY=$DISPLAY --env="QT_X11_NO_MITSHM=1" -e DSUPPORT=1 $2 exoter/taste:14.04
